  ...
  <div class="container-fluid">
    ...
    <div class="col-md-9">
  	<%		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
			...
			String sql="select czy_area from Chenzy_students group by czy_area";
    ...
    <%while(rs.next()){%>
    	<tr>
    		...
    		<% sql="select count(*) num from Chenzy_students where czy_area="+"'"+rs.getString("czy_area")+"'";
    		Statement sm=conn.createStatement();
    		ResultSet rs1=sm.executeQuery(sql);
    		if(rs1.next()){ %>
    		<td><%=rs1.getString("num") %></td>
    		<%} %>
    	</tr>
    <%} %>
	</tbody>
